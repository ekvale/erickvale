...
urlpatterns = [
    ...
    path('analyses/<int:pk>/memos/create/', views.create_memo, name='create_memo'),
    path('analyses/<int:pk>/memos/<int:memo_id>/edit/', views.edit_memo, name='edit_memo'),
    path('analyses/<int:pk>/memos/<int:memo_id>/delete/', views.delete_memo, name='delete_memo'),
